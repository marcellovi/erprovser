            ...
            <div class="row">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3  col-md-4">
                                    <p class="font-weight-400 mb-2">Dt. Abertura</p><input type="text" placeholder="999.999.999-99" class="form-control">
                                </div>
                                <div class="mb-3 col-md-4">
                                    <p class="font-weight-400 mb-2">Dt. Programada</p><input type="text" placeholder="Endereço" class="form-control">
                                </div>
                                <div class="mb-3 col-md-4">
                                    <p class="font-weight-400 mb-2">Tp. Manutenção</p><input type="text" placeholder="+9 (999) 999-9999" class="form-control">
                                </div>
                ...
                <div class="col-lg-2">
                    <div class="widget-box-new widbox-blak" style="height:100%">
                        <div class="text-center"><h5 class="cardHeader">AÇÕES DE GESTÃO</h5></div>


                        <div class="new-bottons"><a href=#" class="card tip-top" title=""
