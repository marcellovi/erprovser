                                ...
                                <div class="mb-3 col-md-12">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <div class="custom-file">
                                            <input type="file" class="custom-file-input" id="inputGroupFile01" aria-describedby="inputGroupFileAddon01" accept="image/*;capture=camera">
                                            <label class="custom-file-label" for="inputGroupFile01">Selecione Imagem do Ativo</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="mb-3 col-md-12">
