            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="card o-hidden mb-4">
                        <div class="card-header d-flex align-items-center">
                            <h3 class="w-50 float-left card-title m-0">Gestão de OS</h3>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-lg-4 col-md-4 mb-4">
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            <h3 class="w-50 float-left card-title m-0">Cadastro de Preventivas</h3>
                        </div>
                        <div class="card-body">
                ...
                <div class="col-md-6">
                    <div class="card o-hidden mb-4">
                        <div class="card-header d-flex align-items-center">
                            <h3 class="w-50 float-left card-title m-0">Gestão de Preventivas</h3>
                        </div>
                        <div class="card-body">
                ...
                <!-- Andamento Preventiva -->
                <div class="col-lg-2 col-md-4 mb-4">
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            <h3 class="w-50 float-left card-title m-0">Progresso</h3>
                        </div>
                        <div class="card-body">

                            <div class="ul-widget-app__poll-list mb-4">
                                <h3 class="heading mr-2">23</h3>
                                <div class="d-flex">
                                    <span class="text-muted text-12">Programada</span>
                            ...
                            <div class="ul-widget-app__poll-list mb-4">
                                <h3 class="heading mr-2">14</h3>
                                <div class="d-flex">
                                    <span class="text-muted text-12">Aberta</span>
                                    <span class="t-font-boldest ml-auto">
                                        63%
                            ...
                            <div class="ul-widget-app__poll-list mb-4">
                                <h3 class="heading mr-2">57</h3>
                                <div class="d-flex">
                                    <span class="text-muted text-12">Em Andamento</span>
                                    <span class="t-font-boldest ml-auto">
                                        73%
                                        <i class="i-Turn-Up-2 text-14 text-success font-weight-700"></i>
                                    </span>
